...
% Fill in data.
\KEYWORDS{online reviews, quality, hotel markets, geographic clustering, state space models}
...
[Insert \Cref{fig:vegas} and \Cref{fig:abmarkets} here]
...
\begin{figure}[htp]
\centering
\subfloat[LATENT PENETRATION\label{fig:latentpen}]{%
  \includegraphics[width=0.5\textwidth,height=\textheight,keepaspectratio]{./Figures/TA_Penetration.png}%
}

\subfloat[LATENT QUALITY: Embassy Suites (Memphis, TN)\label{fig:latentqual}]{%
...
\begin{figure}[htp]
\centering
\subfloat[EXAMPLES OF LAS VEGAS MARKETS\label{fig:vegas}]{%
  \includegraphics[width=0.8\textwidth,height=\textheight,keepaspectratio]{./Figures/LasVegasMarkets.png}%
}

\subfloat[SCHEMATIC REPRESENTATION OF EMPIRICAL TEST\label{fig:abmarkets}]{%
